...
For git basics & tips & tricks - [click me](https://github.com/DevelopersCoffee/developerscoffee.github.io/blob/main/docs/git_tips_tricks.md)! 🖱️
...
![fork-example](https://i.imgur.com/oXi5jAm.png)
...
![clone-example](https://i.imgur.com/xBWZC2K.png)
...
`git clone https://github.com/DevelopersCoffee/developerscoffee.github.io.git`

In your case, you would replace _DevelopersCoffee_ with your username.
...
It should describe the purpose of your changes though. We chose that name because We added DevelopersCoffee to the README (_what you'll do as well_).
...
- Devloper's Coffee 🚀💡 => Twitter: [@DevlopersCoffee](https://twitter.com/DevlopersCoffee) 🐦
